...
@section('content')
	<form action="{{ URL::route('create-client-post') }}" method="post">
		...
		<fieldset>
			...
			<div class="col-md-6">
				...
				<div class="control-group">
					...
					<input type="text" name="monthly_rate" id="monthly_rate" class="form-control input-xlarge" {{ Input::old('monthly_rate') ? 'value="' .Input::old('monthly_rate'). '"' : "" }} >
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<input type="email" name="email" id="email" class="form-control input-xlarge" {{ Input::old('email') ? 'value="' .Input::old('email'). '"' : "" }} >
				</div>
				<div class="control-group">
					<label for="phone_number" class="control-label">Phone Number</label>
					<input type="text" name="phone_number" id="phone_number" class="form-control input-xlarge" {{ Input::old('phone_number') ? 'value="' .Input::old('phone_number'). '"' : "" }} >
				</div>
				<div class="control-group">
					<label for="location" class="control-label">Location</label>
					<input type="text" name="location" id="location" class="form-control input-xlarge" {{ Input::old('location') ? 'value="' .Input::old('location'). '"' : "" }} >
				</div>
			</div>
		</fieldset>
